...
def generate_plot_data(
    model, df, tps, n_points, n_trajectories, n_bins,
    ...
    ----------
        ...
        trajectories (float[float[]]): a list with shape `(n_bins, n_points, len(df.columns) - 1)`
            of the generated trajectories.
    '''
    points = generate_points(model, df, tps, n_points, sample_with_replacement, use_cuda, samples_key, None, autoencoder=autoencoder, recon=recon)
