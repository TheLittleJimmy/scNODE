...
def main(split_type):
    ...
    save_dir = f"/project/Stat/s1155202253/myproject/babydev/benchmark_zebrafish_results/{split_type}/scNODE"
    ...
    # ======================================================
    # Save results
    # Note: save_dir already set above with proper task/method structure
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Benchmark scNODE on zebrafish dataset')
